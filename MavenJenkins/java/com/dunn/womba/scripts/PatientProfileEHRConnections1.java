...
public class PatientProfileEHRConnections1  extends Baselib {
	@Test


public  void PatientProfileEHRConnectionsone() throws InterruptedException  //JVM will handle exception here//
{
    ...
    obj.ehrconnection();  //calling method here//
