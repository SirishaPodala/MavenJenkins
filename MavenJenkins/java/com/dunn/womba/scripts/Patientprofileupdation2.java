...
public class Patientprofileupdation2 extends Baselib {
	@Test


public  void Patientprofileupdationtwo() throws InterruptedException  //JVM will handle exception here//
{
	...
	Patientprofileupdationstep2 obj=new Patientprofileupdationstep2(driver);
	
    obj.step2();  //calling method here//
